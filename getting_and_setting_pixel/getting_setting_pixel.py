...
image = cv2.imread(args["image"])       #this line read the input image and give a numpy array to image variable 
(h, w) = image.shape[:2]                #it represent the image in terms of width an height
plt_imshow("Original", image)           #this line show the image in original dimensions
